...
public class DatiRegistrazione {
    ...
    private String tipoStradaDom;
    private String nomeStradaDom;
    private String numCivicoDom;
    ...
    private String cognomeDocumento;
    private String dataNascitaDocumento;
    ...
    public String getComuneNas() {return comuneNas;}
