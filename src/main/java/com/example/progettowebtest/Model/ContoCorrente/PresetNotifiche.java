...
public class PresetNotifiche {
    ...
    public static String NOTIFICA_BONIFICOINTER="Bonifico internazionale effattuato in data: ";
    ...
    public static String NOTIFICA_SOSPENSIONE_CONTO="Conto sospeso";
}
